...
``` typescript
import pkg from 'https://unpkg.com/arrangekeys@^4.21.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/arrangekeys@^4.21.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/arrangekeys@^4.21.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/arrangekeys@4.21.0'
</script>
```
