...
``` typescript
import pkg from 'https://unpkg.com/arrangekeys@^4.9.0/edition-deno/index.ts'
```
...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/arrangekeys/^4.9.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/arrangekeys@^4.9.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/arrangekeys@4.9.0'
</script>
```
